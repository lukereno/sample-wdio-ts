...
// export default interface BrowserInterface {
...
//     this.element(selector).clearElement();
//   }

//   setValue(selector: string, value: string) {
//     this.element(selector).setValue(value);
//   }

//   addValue(selector: string, value: string) {
//     this.element(selector).addValue(value);
//   }
// }
